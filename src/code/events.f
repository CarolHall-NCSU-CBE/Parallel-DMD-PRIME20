! ============================================================================
!Subroutine events finds type of event for i with each neighbor j,
!sends pair to core, bond, or sqwell subroutine for time calculation, 
!stores event time and partner for the first event that will occur with each. 
...
!Test to see if it's the soonest event i will face; if so, save that time, partner, and event type.
